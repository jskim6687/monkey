...
namespace CSML
{
    public class Matrix
    {
        ...
        public Matrix(Complex[,] values)
        {
            ...
            rowCount = (int)values.GetLength(0);
            columnCount = (int)values.GetLength(1);
        ...
        {
            Matrix P = new Matrix(A.RowCount, B.ColumnCount);

            if (A.RowCount == B.ColumnCount && A.ColumnCount == B.RowCount)
            {
